...
public class EmployeeController {
	...
	@PostMapping("/employee/{id}/{newpassword}/{mobileNumber}")
	public ResponseEntity<String> Login( @PathVariable("id") String id,@PathVariable("mobileNumber")String mobileNumber, @PathVariable("newpassword") String password) {
		String res;
