...
public class Sprint2DemoApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		employee1.setEmployeeDetails(employee1details);
		employee1.setEmployeeId("116001");//empNumber
		employee1.setEmployeePassword("satyam118001");//Firstname + branchid
		employee1Address.setStreet("East of Bus Stand Gangajala");
		employee1Address.setCity("Saharsa");
		employee1Address.setCity("Bihar");
		...
		employee1.setEmployeeDetails(employee2details);
		...
		employee2details.setEmployeeFirstName("Satyam");
		...
		employee3details.setEmployeeFirstName("Satyam");
		employee3details.setEmployeeLastName("Sinha");
		employee3details.setDOB("14/06/1998");
		employee3details.setAge("22");
		employee3details.setPanNumber("QSPFG325S");
		employee3details.setAdharNumber("1698 3152 2084");
		employee3details.setMobileNumber("9963528412");
